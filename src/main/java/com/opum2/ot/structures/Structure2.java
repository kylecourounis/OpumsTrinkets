...
public class Structure2 extends ModStructure {

    public Structure2(World world)
    {
        super(world);

        this.setName("Structure #2");
    }
    ...
    public void build(BlockPos pos)
    {
        ...
        if (!world.isRemote)
        {
            ...
            Template template = manager.get(server, new ResourceLocation(ModInfo.MOD_ID, "structure_2"));
